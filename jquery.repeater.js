...
$.fn.repeater = function (fig) {
    ...
    $(this).each(function () {
        ...
        var appendItem = (function () {
            var setItemsValues = function ($item, data, repeaters) {
                ...
                // Set select2 value
                $filterNested($item.find('select[data-select2]'), repeaters).each(function () {
                  var selectName = $(this).attr('name');
                  var selectValue = data && data[selectName] ? data[selectName] : null;
              
                  // Set select2 value for single select
                  if (!$(this).prop('multiple')) {
                    $(this).val(selectValue).trigger('change');
                  } else {
                    // Set select2 value for multiple select
                    var valuesArray = selectValue ? selectValue.split(',') : [];
        ...
        setListWithSelect2 = function (rows) {
            $items().remove();
            foreach(rows, addItem);
        };
    ...
    this.setListWithSelect2 = setListWithSelect2;
